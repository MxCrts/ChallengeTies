      ...
      <View style={styles.container}>
        ...
        >
          ...
          <Animated.View style={[styles.card, { opacity: fadeAnim }]}>
            <Text style={styles.title}>Crée et Partage ton Parcours</Text>
            <Text style={styles.text}>
              Partage tes réussites et inspire les autres à relever leurs défis.
              Reste connecté avec ta communauté et crée des liens puissants.
            </Text>
          </Animated.View>
